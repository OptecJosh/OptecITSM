...
try {
    ...
    // Same as send_message.php: an analyst chose to send this, so it is a reply.
    // (Contrast webchatInsertOutbound, which posts the AI's answers, and
    // template_email.php, which sends automated notices — neither stamps.)
    try {
