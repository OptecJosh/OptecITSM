...
requireCapabilityJson(Cap::PROBLEMS_STATUSES);   // settings tab — see docs/design/rbac.md
try {
    ...
    if ($id > 0) {
        ...
        wf_emit('problem_status', 'updated', $id, $name);
        ...
        wf_emit('problem_status', 'created', $newId, $name);
