...
try {
    ...
    $in = [];
    foreach (['department_id', 'ticket_type_id', 'category_id', 'subcategory_id', 'status', 'origin_id', 'first_time_fix', 'it_training_provided', 'priority_id', 'assigned_analyst_id', 'stream_id', 'playbook_eligible', 'customer_id', 'customer_contact_id', 'hold_reason'] as $k) {
