...
try {
    ...
    $sql = "SELECT id, username, full_name, email, is_active, auth_provider_id, can_access_all_tenants, is_admin, can_access_all_modules, manager_id, tier, loaded_rate, contracted_weekly_hours, created_datetime, last_login_datetime, last_modified_datetime
            FROM analysts
            ORDER BY full_name";
