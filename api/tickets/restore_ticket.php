 ...
 * Thin UI adapter over TicketsService::restoreTicket. writeAudit=true — the UI
...
try {
    ...
    TicketsService::restoreTicket($conn, ActorContext::fromSession($conn), (int)$data['ticket_id'], true);
