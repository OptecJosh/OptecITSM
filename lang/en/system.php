...
return [
    ...
    'landing' => [
        ...
        'reset_desc'      => 'Delete records - tickets, assets, CMDB items and the rest - while keeping the platform you configured. Preview first; there is no undo.',
        'reset_keywords'  => 'reset wipe clear delete purge empty test data uat teardown start again fresh clean records truncate rollback demo data remove',
        'inbound_title'    => 'Inbound webhooks',
        'inbound_desc'     => 'Let monitoring, alerting or any other system raise tickets by POSTing to a URL of yours - with signature checking, field mapping and a full delivery log.',
        'inbound_keywords' => 'inbound webhook receive post incoming integration monitoring alerting grafana prometheus alertmanager datadog nagios zabbix sensu pagerduty api endpoint hmac signature secret payload mapping raise ticket automation',
