...
return [
    ...
    'help' => [
        ...
        'triggers_time_cron'    => '<strong>If those crons aren\'t scheduled, these triggers never fire.</strong> The workflow will sit there, active, doing nothing. SLA events come from the SLA breach-check cron (every 5 minutes); the expiry events from <code>cron/workflow_scheduled.php</code> (hourly is plenty). Setup: <code>docs/workflow-scheduled-cron-setup.md</code>.',
