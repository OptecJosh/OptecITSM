...
<head>
    ...
    <style>
        .syshelp-container { display: flex; height: calc(100vh - 48px); background: #f5f6fa; }

        .syshelp-sidebar { width: 250px; background: #fff; border-right: 1px solid #e5e7eb; padding: 20px; flex-shrink: 0; overflow-y: auto; }
        .syshelp-sidebar h3 { font-size: 11px; font-weight: 700; color: #9aa; text-transform: uppercase; letter-spacing: 0.6px; margin: 0 0 12px; }
        ...
        .syshelp-nav-link { display: flex; align-items: center; gap: 10px; padding: 9px 11px; border-radius: 6px; font-size: 13px; color: #555; text-decoration: none; }
        .syshelp-nav-link:hover { background: #f3f4f6; color: #222; }
        .syshelp-nav-link.active { background: #eef2ff; color: #3730a3; font-weight: 600; }
        .syshelp-nav-num { display: flex; align-items: center; justify-content: center; min-width: 22px; height: 22px; border-radius: 50%; background: #eee; color: #888; font-weight: 700; font-size: 11px; flex-shrink: 0; }
        ...
        .syshelp-section { padding: 26px 0; border-bottom: 1px solid #ececf1; scroll-margin-top: 20px; }
        ...
        .syshelp-section-header h3 { margin: 0; font-size: 18px; color: #1f2330; }
        ...
        .syshelp-section p { font-size: 14px; color: #4b5563; line-height: 1.7; margin: 0 0 12px; }
        .syshelp-lead { font-size: 14.5px !important; color: #374151 !important; }
        .syshelp-section ul, .syshelp-section ol { font-size: 14px; color: #4b5563; line-height: 1.7; margin: 0 0 12px; padding-left: 22px; }
        ...
        .syshelp-section h4 { font-size: 14px; color: #1f2330; margin: 18px 0 8px; }

        .syshelp-cards { display: grid; grid-template-columns: repeat(2, 1fr); gap: 14px; margin: 6px 0 14px; }
        .syshelp-card { padding: 18px; border-radius: 10px; border: 1px solid #e5e7eb; background: #fff; }
        .syshelp-card h4 { margin: 0 0 6px; font-size: 14.5px; color: #1f2330; }
        .syshelp-card p { margin: 0; font-size: 13px; color: #6b7280; line-height: 1.55; }

        .syshelp-steps { display: flex; flex-direction: column; gap: 10px; margin: 8px 0 14px; }
        .syshelp-step { display: flex; align-items: flex-start; gap: 14px; padding: 12px 16px; border-radius: 8px; background: #fafafa; font-size: 14px; color: #444; line-height: 1.55; }
        ...
        .syshelp-step strong { color: #1f2330; }

        .syshelp-callout { font-size: 13.5px; line-height: 1.6; padding: 12px 16px; border-radius: 8px; margin: 12px 0; border-left: 3px solid #9ca3af; background: #f9fafb; color: #374151; }
        .syshelp-callout.info { border-left-color: #6366f1; background: #eef2ff; color: #3730a3; }
        .syshelp-callout.warn { border-left-color: #f59e0b; background: #fffbeb; color: #92400e; }
        ...
        .syshelp-table th, .syshelp-table td { text-align: left; padding: 9px 12px; border-bottom: 1px solid #ececf1; color: #4b5563; vertical-align: top; }
        .syshelp-table th { color: #1f2330; font-weight: 600; background: #f9fafb; }
