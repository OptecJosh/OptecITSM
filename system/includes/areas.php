...
function getSystemAreas() {
    return [
        [
            'icon'     => 'audit',
            'url'      => 'audit/',
            'title'    => 'system.landing.audit_title',
            'desc'     => 'system.landing.audit_desc',
        ...
        [
            'icon'     => 'import',
            'url'      => 'import/',
            'title'    => 'system.landing.import_title',
            'desc'     => 'system.landing.import_desc',
            'keywords' => 'system.landing.import_keywords',
        ],
        [
            'icon'     => 'reset',
            'url'      => 'reset/',
            'title'    => 'system.landing.reset_title',
            'desc'     => 'system.landing.reset_desc',
        ...
        [
            ...
            'desc'     => 'system.landing.migrate_desc',
            'keywords' => 'system.landing.migrate_keywords',
        ],
        [
            'icon'     => 'encryption',
            'url'      => 'encryption/',
